...
class BinanceWsClientShard extends BaseWsClient {

    private static final Logger log = LoggerFactory.getLogger(BinanceWsClientShard.class);
    ...
    BinanceWsClientShard(String wsBaseUrl, String restBaseUrl, List<String> symbols,
