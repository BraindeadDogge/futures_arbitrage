...
class BybitWsClientShard extends BaseWsClient {

    private static final Logger log = LoggerFactory.getLogger(BybitWsClientShard.class);
    ...
    BybitWsClientShard(String wsBaseUrl, List<String> symbols,
