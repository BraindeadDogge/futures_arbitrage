...
class OkxWsClientShard extends BaseWsClient {

    private static final Logger log = LoggerFactory.getLogger(OkxWsClientShard.class);
    ...
    OkxWsClientShard(String wsBaseUrl, Map<String, String> canonicalToOkx,
