...
class KuCoinWsClientShard extends BaseWsClient {

    private static final Logger log = LoggerFactory.getLogger(KuCoinWsClientShard.class);
    ...
    KuCoinWsClientShard(String restBaseUrl, Map<String, String> canonicalToKucoin,
