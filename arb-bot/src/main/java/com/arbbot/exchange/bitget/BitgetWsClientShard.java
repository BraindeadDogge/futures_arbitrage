...
class BitgetWsClientShard extends BaseWsClient {

    private static final Logger log = LoggerFactory.getLogger(BitgetWsClientShard.class);
    ...
    BitgetWsClientShard(String wsBaseUrl, List<String> symbols,
